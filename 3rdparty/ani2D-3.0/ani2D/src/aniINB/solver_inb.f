...
c
c  RESID    = on input: stopping tolerance on the f-norm.
c             on output: actual norm of the residual.
c
...
c Test for stopping. 
c------------------------------------------------------------------------
      if (iPrint.ge.1) write(*,*)'Newton step ',nni,' ||f||=',fcnrm
