...
/* Fortran interface for the C-callable AMD library (int version only).  This is
 * HIGHLY non-portable.  You will need to modify this depending on how your
 ...
 * after each routine name.  C doesn't do this, so the translation is made here.
 * Some Fortran compilers don't append an underscore (xlf on IBM AIX, for
 * example).
 *
