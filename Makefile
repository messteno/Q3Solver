...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/QMesh1.0.0/ && $(COPY_FILE) --parents mainwindow.h .tmp/QMesh1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/QMesh1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/QMesh1.0.0/ && (cd `dirname .tmp/QMesh1.0.0` && $(TAR) QMesh1.0.0.tar QMesh1.0.0 && $(COMPRESS) QMesh1.0.0.tar) && $(MOVE) `dirname .tmp/QMesh1.0.0`/QMesh1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/QMesh1.0.0
